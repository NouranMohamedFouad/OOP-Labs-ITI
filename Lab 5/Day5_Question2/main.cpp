...
int main()
{
    ...
    Picture myPic;
    Circle cArr[3] = { Circle(50, 50, 50,BROWN), Circle(200, 100, 100,BROWN), Circle(420, 50, 30,BROWN) };
    Rect rArr[2] = { Rect(30, 40, 170, 100,CYAN), Rect(420, 50, 500, 300,CYAN) };
    Line lArr[2] = { Line(420, 50, 300, 300,WHITE), Line(40, 500, 500, 400,WHITE) };
